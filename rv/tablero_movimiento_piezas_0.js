...
function Ayuda(x=0,y=0,z=0){
  Agent.call(this,x,y,z);
  var posibilidades = new THREE.MeshLambertMaterial({color: 0x00ff00});
  this.add(new THREE.Mesh(new THREE.BoxGeometry(10.1,10.1,10.1),posibilidades));
  this.position.y=y;
  this.position.z=z;
  this.position.x=x;
}
...
function Seleccion(x=0,y=0,z=0){
  Agent.call(this,x,y,z);
  var sseleccion = new THREE.MeshLambertMaterial({color: 0xff0000});
  this.add(new THREE.Mesh(new THREE.BoxGeometry(10.2,10.2,10.2),sseleccion));
  this.position.y=y;
  this.position.z=z;
  this.position.x=x;
}
...
function Cursor(x=0,y=0,z=0){
  Agent.call(this,x,y,z);
  var scursor =  new THREE.MeshLambertMaterial({color: 0xffff00});
